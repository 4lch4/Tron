...
const fields = {
  ...
  'messageCacheMaxSize': "Maximum number of messages to cache per channel (-1 or Infinity for unlimited - don't do this without message sweeping, otherwise memory usage will climb indefinitely)",
...
const getFieldData = (field, client) => {
  switch (field) {
    ...
    case 'presence': return { presence: client.options.presence }
